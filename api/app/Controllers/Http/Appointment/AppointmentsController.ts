...
export default class AppointmentsController {
    ...
    async request(ctx: HttpContextContract) {
        ...
        for (let i of isAvailable) {
            // console.log(i.forWhichTimeSlot.toJSON());
        ...
        data.date = moment(data.date).format('ddd MMM DD YYYY');
    ...
    public async made(ctx: HttpContextContract){
        return await this.appoinmentService.made(ctx);
    }
}
